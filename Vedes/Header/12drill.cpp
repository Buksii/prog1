#include "Header/Simple_window.h" //g++  bemeneti.cpp -o kimeneti
#include "Header/GUI.h" //g++ -w -Wall Graph.cpp Window.cpp GUI.cpp Simple_window.cpp 12drill.cpp `fltk-config --ldflags --use-images` -o a2.out 
